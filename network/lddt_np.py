...
if __name__ == '__main__':
    ...
    # jnp.save("test_lddt_predict", predicted_points)
    # jnp.save("test_lddt_true", true_points)

    predicted_points = jnp.arange(1500).reshape(10, 50, 3)
    true_points = jnp.arange(1500, 3000)
    true_points[0:10] += 1
    true_points = true_points.reshape(10, 50, 3)
